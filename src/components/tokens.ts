...
// ── Wraith Finance — Design tokens (black/white brand, clean editorial) ──────────────
...
export const T = {
  ...
  blue:    "#0A0A0B",   // Wraith Finance primary accent → near-black (light mode)
...
// Wraith Finance display font — Cormorant Garamond (loaded in layout.tsx)
