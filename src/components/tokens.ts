...
// ── Alca — Design tokens (black/white brand, clean editorial) ──────────────
...
export const T = {
  ...
  blue:    "#0A0A0B",   // Alca primary accent → near-black (light mode)
...
// Alca display font — Cormorant Garamond (loaded in layout.tsx)
